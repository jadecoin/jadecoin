...
const string strMessageMagic = "JadeCoin Signed Message:\n";
...
{
    int64_t nSubsidy = 586 * COIN;
    
    if (pindexBest->nHeight == 1)
      {
        int64_t nSubsidy = 90000 * COIN;
        return nSubsidy + nFees;
      }
      
    else if (pindexBest->nHeight <= 41)
      {
        int64_t nSubsidy = 78 * COIN;
        return nSubsidy + nFees;
      }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JadeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbdc80598c301ae3f2ed1f7565d1b9fe719b6ba78613d962dc229ebfb5fdc69e7"));
        block.print();
